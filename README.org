...
;; where is a certain system installed?
(ql:where-is-system :graph-db)

;; update ultralisp metadata (not often needed)
(ql:update-dist "ultralisp") ; must be string (generic function)

;; uninstall a dist including ultralisp
(asdf:clear-system "ultralisp") ;; sometimes without effect
#+END_SRC
